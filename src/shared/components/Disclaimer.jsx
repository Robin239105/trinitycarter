...
export const Disclaimer = () => {
  return (
    <section className="py-12 px-8 bg-black/50 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <p className="text-[10px] md:text-[11px] leading-relaxed text-white/60 text-center font-['Inter'] uppercase tracking-wider max-w-5xl mx-auto">
